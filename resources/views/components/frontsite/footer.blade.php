<footer aria-label="Site Footer" class="bg-gray-100">
    ...
    >
      <div class="absolute top-4 right-4 sm:top-6 sm:right-6 lg:top-8 lg:right-8">
        <a
          class="inline-block rounded-full bg-blue-600 p-2 text-white shadow transition hover:bg-blue-700 sm:p-3 lg:p-4"
          href="#MainContent"
        >
      ...
      <div class="lg:flex lg:items-end lg:justify-between">
        <div>
            <a href="#_" class="box-border inline-block font-extrabold text-2xl text-left text-blue-600 hover:text-blue-700 drop-shadow-lg shadow-gray-600 no-underline bg-transparent cursor-pointer focus:no-underline">
                Sinar Cell
            </a>
