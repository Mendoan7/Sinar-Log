<!-- JAVASCRIPT -->
<script src="{{ asset('/assets/backsite/libs/jquery/jquery.min.js') }}"></script>
<script src="{{ asset('/assets/backsite/libs/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset('/assets/backsite/libs/metismenu/metisMenu.min.js') }}"></script>
...
<script src="{{ asset('/assets/backsite/libs/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js') }}"></script>
<script src="{{ asset('/assets/backsite/libs/jszip/jszip.min.js') }}"></script>
<script src="{{ asset('/assets/backsite/libs/pdfmake/build/pdfmake.min.js') }}"></script>
<script src="{{ asset('/assets/backsite/libs/pdfmake/build/vfs_fonts.js') }}"></script>
<script src="{{ asset('/assets/backsite/libs/datatables.net-buttons/js/buttons.html5.min.js') }}"></script>
